...
df = pd.read_csv('data/mil.csv', dtype={'b_count': 'category', 's_count' : 'category', 'pitcher_id' : 'category', 'pitch_type' : 'category', 'stand': 'category' })
...
ballsmil = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strikemil = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

battermil = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
figmil = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("Milwakee Brewers Match Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pitchmil', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'ballsmil',     #increase num
                                         options = ballsmil,
                                         value = ballsmil[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strikemil', options = strikemil, value = strikemil[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'battermil', options = battermil, value = battermil[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='gmil',figure = figmil)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('gmil', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('pitchmil','value'),
    Input('ballsmil','value'),
    Input('strikemil','value'),
    Input('battermil', 'value')]
    )
...
@app.callback(
    Output('tablemil', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchmil','value')])
...
@app.callback(
    Output('tablemil1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchmil','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitchmil', 'options'),        #increase num
    [Input('opt', 'value')])
