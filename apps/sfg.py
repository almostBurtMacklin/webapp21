...
df = pd.read_csv('data/sfg.csv', dtype={'b_count': 'category', 's_count' : 'category', 'pitcher_id' : 'category', 'pitch_type' : 'category', 'stand': 'category' })
...
ballsfg = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strikesfg = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

battersfg = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
figsfg = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("San Fransico Giants Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pitchsfg', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'ballsfg',     #increase num
                                         options = ballsfg,
                                         value = ballsfg[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strikesfg', options = strikesfg, value = strikesfg[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'battersfg', options = battersfg, value = battersfg[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='gsfg',figure = figsfg)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('gsfg', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('pitchsfg','value'),
    Input('ballsfg','value'),
    Input('strikesfg','value'),
    Input('battersfg', 'value')]
    )
...
@app.callback(
    Output('tablesfg', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchsfg','value')])
...
@app.callback(
    Output('tablesfg1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchsfg','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitchsfg', 'options'),        #increase num
    [Input('opt', 'value')])
