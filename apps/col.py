...
df = pd.read_csv('data/col.csv', dtype={'b_count': 'category', 's_count' : 'category', 'pitcher_id' : 'category', 'pitch_type' : 'category', 'stand': 'category' })
...
ballscol = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strikecol = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

battercol = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("Colorado Rockies Match Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pitchcol', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'ballscol',     #increase num
                                         options = ballscol,
                                         value = ballscol[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strikecol', options = strikecol, value = strikecol[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'battercol', options = battercol, value = battercol[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='gfig',figure = figcol)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('gfig', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('pitchcol','value'),
    Input('ballscol','value'),
    Input('strikecol','value'),
    Input('battercol', 'value')]
    )
...
@app.callback(
    Output('tablecol', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchcol','value')])
...
@app.callback(
    Output('tablecol1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchcol','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitchcol', 'options'),        #increase num
    [Input('opt', 'value')])
