...
df = pd.read_csv('data/lad.csv', dtype={'b_count': 'category', 's_count' : 'category', 'pitcher_id' : 'category', 'pitch_type' : 'category', 'stand': 'category' })
...
ballslad = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strikelad = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

batterlad = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
figlad = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("Los Angeles Dodgers Match Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pitchlad', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'ballslad',     #increase num
                                         options = ballslad,
                                         value = ballslad[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strikelad', options = strikelad, value = strikelad[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'batterlad', options = batterlad, value = batterlad[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='glad',figure = figlad)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('glad', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('pitchlad','value'),
    Input('ballslad','value'),
    Input('strikelad','value'),
    Input('batterlad', 'value')]
    )
...
@app.callback(
    Output('tablelad', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchlad','value')])
...
@app.callback(
    Output('tablelad1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchlad','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitchlad', 'options'),        #increase num
    [Input('opt', 'value')])
