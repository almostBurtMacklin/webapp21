...
df = pd.read_csv('data/det.csv', dtype={'b_count': str, 's_count' : str})
...
ballsdet = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strikedet = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

batterdet = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
figdet = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("Detroit Tigers Match Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pitchdet', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'ballsdet',     #increase num
                                         options = ballsdet,
                                         value = ballsdet[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strikedet', options = strikedet, value = strikedet[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'batterdet', options = batterdet, value = batterdet[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='gdet',figure = figdet)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('gdet', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('pitchdet','value'),
    Input('ballsdet','value'),
    Input('strikedet','value'),
    Input('batterdet', 'value')]
    )
...
@app.callback(
    Output('tabledet', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchdet','value')])
...
@app.callback(
    Output('tabledet1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchdet','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitchdet', 'options'),        #increase num
    [Input('opt', 'value')])
