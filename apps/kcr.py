...
df = pd.read_csv('data/kcr.csv', dtype={'b_count': str, 's_count' : str})
...
bkcr = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

skcr = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
figkcr = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
                ...
                html.Div([
                    html.Div([
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pkcr', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'bkcr',     #increase num
                                         options = bkcr,
                                         value = bkcr[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'skcr', options = skcr, value = skcr[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'bakcr', options = bakcr, value = bakcr[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='gkcr',figure = figkcr)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('gkcr', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('pkcr','value'),
    Input('bkcr','value'),
    Input('skcr','value'),
...
@app.callback(
    Output('tablekcr', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pkcr','value')])
...
@app.callback(
    Output('tablekcr1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pkcr','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pkcr', 'options'),        #increase num
    [Input('opt', 'value')])
