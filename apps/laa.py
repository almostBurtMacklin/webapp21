...
df = pd.read_csv('data/laa.csv', dtype={'b_count': 'category', 's_count' : 'category', 'pitcher_id' : 'category', 'pitch_type' : 'category', 'stand': 'category' })
...
blaa = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

slaa = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

balaa = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("Los Angeles Angels Match Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'plaa', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'blaa',     #increase num
                                         options = blaa,
                                         value = blaa[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'slaa', options = slaa, value = slaa[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'balaa', options = balaa, value = balaa[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='glaa',figure = figlaa)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('glaa', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('plaa','value'),
    Input('blaa','value'),
    Input('slaa','value'),
...
@app.callback(
    Output('tablelaa', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('plaa','value')])
...
@app.callback(
    Output('tablelaa1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('plaa','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('plaa', 'options'),        #increase num
    [Input('opt', 'value')])
