...
balls5 = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strike5 = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

batter5 = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("Toronto Blue Jays Match Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'balls5',     #increase num
                                         options = balls5,
                                         value = balls5[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strike5', options = strike5, value = strike5[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'batter5', options = batter5, value = batter5[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='g6',figure = fig5)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('table10', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitch5','value')])
...
@app.callback(
    Output('table11', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitch5','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitch5', 'options'),        #increase num
    [Input('opt', 'value')])
