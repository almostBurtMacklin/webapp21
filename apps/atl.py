...
df = pd.read_csv('data/atl.csv', dtype={'b_count': str, 's_count' : str})
...
ballsatl = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strikeatl = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

batteratl = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
figatl = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
                ...
                html.Div([
                    html.Div([
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pitchatl', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'ballsatl',     #increase num
                                         options = ballsatl,
                                         value = ballsatl[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strikeatl', options = strikeatl, value = strikeatl[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'batteratl', options = batteratl, value = batteratl[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='gatl',figure = figatl)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('gatl', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('pitchatl','value'),
    Input('ballsatl','value'),
    Input('strikeatl','value'),
    Input('batteratl', 'value')]
    )
...
@app.callback(
    Output('tableatl', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchatl','value')])
...
@app.callback(
    Output('tableatl1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchatl','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitchatl', 'options'),        #increase num
    [Input('opt', 'value')])
