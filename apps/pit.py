...
df = pd.read_csv('data/pit.csv', dtype={'b_count': 'category', 's_count' : 'category', 'pitcher_id' : 'category', 'pitch_type' : 'category', 'stand': 'category' })
...
bpit = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

spit = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

bapit = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
figpit = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("Pittsburg Pirates Match Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'ppit', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'bpit',     #increase num
                                         options = bpit,
                                         value = bpit[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'spit', options = spit, value = spit[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'bapit', options = bapit, value = bapit[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='gpit',figure = figpit)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('gpit', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('ppit','value'),
    Input('bpit','value'),
    Input('spit','value'),
...
@app.callback(
    Output('tablepit', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('ppit','value')])
...
@app.callback(
    Output('tablepit1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('ppit','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('ppit', 'options'),        #increase num
    [Input('opt', 'value')])
