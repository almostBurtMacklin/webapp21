...
df = pd.read_csv('data/mins.csv', dtype={'b_count': 'category', 's_count' : 'category', 'pitcher_id' : 'category', 'pitch_type' : 'category', 'stand': 'category' })
...
balls7 = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strike7 = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

batter7 = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
fig7 = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
...
layout = html.Div([
                ...
                html.Div([ 
                    html.Div([
                        ...
                        html.H1("Minnesota Twins Match Up Chart - Pitcher Tendencies",
                         style = {#'backgroundColor' : '#512888',
                                 'color': darker,
                                  'text-align' : 'center',
                                  'height': '50px',
                                  'text-shadow' : '-1px -1px 0 #b9975b, 1px -1px 0 #b9975b, -1px 1px 0 #b9975b, 1px 1px 0 #b9975b'}),
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pitch7', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'balls7',     #increase num
                                         options = balls7,
                                         value = balls7[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strike7', options = strike7, value = strike7[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'batter7', options = batter7, value = batter7[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='g8',figure = fig7)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('table14', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitch7','value')])
...
@app.callback(
    Output('table15', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitch7','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitch7', 'options'),        #increase num
    [Input('opt', 'value')])
