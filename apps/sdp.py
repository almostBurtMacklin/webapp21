...
df = pd.read_csv('data/sdp.csv', dtype={'b_count': 'category', 's_count' : 'category', 'pitcher_id' : 'category', 'pitch_type' : 'category', 'stand': 'category' })
...
ballssdp = [{'label' : '0', 'value' : '0.0'},             #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'},
         {'label' : '3', 'value' : '3.0'}]

strikesdp = [{'label' : '0', 'value' : '0.0'},            #increase num
         {'label' : '1', 'value' : '1.0'},
         {'label' : '2', 'value' : '2.0'}]

battersdp = [{'label' : 'Right', 'value' : 'R'},          #increase num
         {'label' : 'Left', 'value' : 'L'}]
...
layouts = go.Layout(height = 600,
                   width = 600)
figsdp = go.Figure(data = [trace_1], layout = layouts)    #increase num
value = opts[0]['value']
...
layout = html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.H1("San Diego Padres Match Up Chart - Pitcher Tendencies",
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'pitchsdp', options = tops, value = tops[0]['value'])],  #increase num
                            style = {'width': '250px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'ballssdp',     #increase num
                                         options = ballssdp,
                                         value = ballssdp[0]['value'])],
                        ...
                        html.P([
                            ...
                            dcc.Dropdown(id = 'strikesdp', options = strikesdp, value = strikesdp[0]['value'])],  #increase num
                            style = {'width': '150px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
                                            'display': 'inline-block'}),
                        html.P([
                            ...
                            dcc.Dropdown(id = 'battersdp', options = battersdp, value = battersdp[0]['value'])],      #increase num
                            style = {'width': '300px',
                                            'fontSize' : '20px',
                                            'padding-left' : '75px',
...
##                                    'display': 'inline-block'}),
                ...
                html.Div([
                    html.Div([
                        ...
                        dcc.Graph(id='gsdp',figure = figsdp)],  style={                         #increase num
                                                                    "display": "block",
                                                                    "margin-left": "auto",
                                                                    "margin-right": "auto",
                                                                    "width" : "auto"
...
@app.callback(
    Output('gsdp', 'figure'), #increase num
    [Input('opt', 'value'),
    Input('pitchsdp','value'),
    Input('ballssdp','value'),
    Input('strikesdp','value'),
    Input('battersdp', 'value')]
    )
...
@app.callback(
    Output('tablesdp', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchsdp','value')])
...
@app.callback(
    Output('tablesdp1', 'data'),       #increase num
    [Input('opt', 'value'),
    Input('pitchsdp','value')])
def update_table_Right(pitcher, value):
    ...
    return final.to_dict('records')
@app.callback(
    Output('pitchsdp', 'options'),        #increase num
    [Input('opt', 'value')])
